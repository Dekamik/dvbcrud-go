...
func TestParseFieldNames(t *testing.T) {
    ...
    actual, _ := ParseFieldNames[structTestUser]()
...
func TestParseFieldNames_NonStructType(t *testing.T) {
    _, err := ParseFieldNames[int]()
    if err == nil {
...
func TestParseFieldNames_MissingTag(t *testing.T) {
    _, err := ParseFieldNames[testMissingTagAddress]()
    if err == nil {
